 ...
 * @description:TODO
 */
public class SmsgTaskInfoCreator extends ICreateTaskInfo {

	@Override
	public int getTaskType() {
		return ProgramConfig.TASK_TYPE_SMSG;
	}
	
	public SmsgTaskInfoCreator() {
		String dir = ProgramConfig.SMSG.getConfig(ConstantKey.ufs_send_dir, "e:/UFS/CMM/save/CMM/") + 
	...
	public UfsTaskInfo createTaskInfo() {
		...
		//构造源系统发送路径
		String srcDir = ProgramConfig.SMSG.getConfig(ConstantKey.ufs_send_dir, "e:/UFS/CMM/save/CMM/") + 
							  ProgramConfig.SMSG.getConfig(ConstantKey.ufs_task_seq, "90001") + "/" + 
							  dateStr + "/";
		//判断是否需要创建发送目录
		...
		//构造目标系统接收路径
		String aimDir = ProgramConfig.SMSG.getConfig(ConstantKey.ufs_save_dir, "e:/UFS/CMM/save/CMM/") + 
								ProgramConfig.SMSG.getConfig(ConstantKey.ufs_task_seq, "90001") + "/" +
								dateStr + "/";
		...
		synchronized(this.numFmt){
			...
			String srcFileName = ProgramConfig.SMSG.getConfig(ConstantKey.ufs_file_name, "CMM_EDMS_") + 
					ProgramConfig.SMSG.getConfig(ConstantKey.ufs_task_seq, 90001) + "_" +
