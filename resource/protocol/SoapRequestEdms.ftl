...
<soapenv:Body>
	<gateway:NoAS400>
		<gateway:field name="taskName">${taskName}</gateway:field>
		<gateway:field name="mark">${mark}</gateway:field>
		<gateway:field name="FileCount">${FileCount}</gateway:field>
		<gateway:field name="SendBeginDate">${SendBeginDate}</gateway:field>
		<gateway:field name="SendEndDate">${SendEndDate}</gateway:field>
		<gateway:field name="RecordNum">${RecordNum}</gateway:field>
